...
## RN03 - Atribuição de Correção de Atividades:
Apenas o Professor da turma pode corrigir atividades.

## RN04 - Acessos a relatórios:
Apenas Coordenadores podem visualizar relatórios.

## RN05 - Automação de notificações:
